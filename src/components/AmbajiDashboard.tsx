...
interface AmbajiDashboardProps {
  onBack: () => void;
}

export function AmbajiDashboard({ onBack }: AmbajiDashboardProps) {
  const templeData = {
    ...
    status: "low",
    youtubeId: "jNQXAC9IVRw", // Live Ambaji Temple stream
    color: "red"
  };
  ...
  const todayStats = {
    totalVisitors: "1,680 | कुल दर्शनार्थी",
    avgWaitTime: "8 min | औसत प्रतीक्षा",
    parkingUtilization: "45% | पार्किंग उपयोग", 
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-red-600">लाइव डैशबोर्ड | Live Dashboard</p>
            </div>
          </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-xs space-y-1 text-gray-600">
                        <div>• कुल दर्शनार्थी | Total Visitors: 1,680</div>
                        <div>• औसत प्रतीक्षा | Avg Wait: 8 min</div>
                        <div>• पार्किंग | Parking: 45% full</div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <span>पहाड़ी रास्ता | Hill Road</span>
                        <Badge className="bg-green-100 text-green-700">अच्छा | Good</Badge>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span>मंदिर एक्सेस | Temple Access</span>
                        <Badge className="bg-green-100 text-green-700">खुला | Open</Badge>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span>पैदल रास्ता | Walking Path</span>
            ...
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="space-y-3">
                ...
                <button className="w-full p-3 text-left bg-purple-50 hover:bg-purple-100 rounded-lg border border-purple-200 transition-colors">
                  <div className="flex items-center">
                    <Mountain className="h-4 w-4 text-purple-600 mr-3" />
                    <div>
                      <div className="font-medium text-purple-700">पहाड़ी सुरक्षा | Hill Safety</div>
                      <div className="text-xs text-purple-600">पहाड़ी मार्ग सुरक्षा जांच | Check hill route safety</div>
                    </div>
                  </div>
                </button>
